...
<div class = "page-header container col-xs-12 form-group">
	<div class = "col-xs-10">
		<h1 style="text-align:left; display:inline">Food Ordering - </h1><h2 style="text-align:center; display:inline">(Place Home Delivery Orders)</h3>
	</div>
	<div class = "col-xs-2"  >
			...
			<div class="row-xs-12">
				...
				<div class="col-xs-4">
					<div class="card">
						<img class="card-img-top" src="..." alt="">
						<div class="card-block">
							<h4 class="card-title">Buffalo Lamb</h4>
	...
	$('a').click(function(){
		...
		if( id == "add"){
			...
			$.ajaxSetup({
				...
				$.ajax({
					url: "/homed-orders/delete-shawarma",
					method: "POST",
					data: {
						item:val
						},
